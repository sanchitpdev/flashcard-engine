  ...
  return (
    <div className="page">
      ...
      {decks.length===0 ? (
        ...
        <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(min(100%, 520px), 1fr))', gap:12 }}>
          {decks.map((deck, i) => {
            ...
            return (
              <div key={deck.id} className="card animate-in" style={{ animationDelay:`${i*0.05}s`, display:'flex', alignItems:'center', gap:16, padding:'18px 20px', opacity: ready?1:0.65, flexWrap:'wrap' }}>
